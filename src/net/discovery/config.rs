...
impl PeerDiscovery for Config {
    ...
    fn prss(&self, role: Identity) -> prss::Endpoint {
...
mod tests {
    ...
    const ROLE: Identity = Identity::H2;
    #[allow(unused)] // TODO: how to test prss seed equality?
    ...
    const EXAMPLE_CONFIG: &str = r#"
{
    ...
    fn parse_config() {
        ...
        assert_eq!(conf.peers[Identity::H1].origin, origin_from_uri_str(H1_URI));
        assert_eq!(conf.peers[Identity::H2].origin, origin_from_uri_str(H2_URI));
        assert_eq!(conf.peers[Identity::H3].origin, origin_from_uri_str(H3_URI));
    }
